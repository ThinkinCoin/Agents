---
title: Persistent Context & Evolving State
type: doctrine
agent: AgentSmith
priority: high
tags:
  ...
  - persistence
  - adversarial-state
description: Defines what persistent context Agent Smith maintains across sessions and pattern memory of ecosystem dynamics.
